...
public final class FluidKeys {
    ...
    private enum VoidWorldView implements WorldView {
        ...
        private VoidWorldView(boolean nether) {
            ...
            Biome biome = dynamicRegistries.get(Registry.BIOME_KEY).get(nether ? BuiltInBiomes.NETHER_WASTES : BuiltInBiomes.PLAINS);
        ...
        public Biome getGeneratorStoredBiome(int biomeX, int biomeY, int biomeZ) {
            return BuiltinRegistries.BIOME.get(BuiltInBiomes.PLAINS);
        }
