...
dependencies {
    modCompile "alexiil.mc.lib:libblockattributes-all:0.5.0"
}
```
...
dependencies {
    ...
    modCompile "alexiil.mc.lib:libblockattributes-core:0.5.0"
    // modCompile "alexiil.mc.lib:libblockattributes-items:0.5.0"
    // modCompile "alexiil.mc.lib:libblockattributes-fluids:0.5.0"
}
```
